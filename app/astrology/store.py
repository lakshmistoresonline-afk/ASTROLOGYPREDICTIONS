...
if USE_FIREBASE:
    ...
    def save_prediction_snapshot(chart_id: str, domain_pred: dict):
        ...
        snapshot = PredictionOutcome(
            ...
            evidence_version="EVIDENCE-HIERARCHY-9L", # V3 Upgrade
            remedy_version="REMEDY-CONTEXT-V3",
            prompt_version="PROMPT-MASTER-JYOTISHI-V2",
            domain=domain_pred.get("domain"),
            prediction_strength=domain_pred.get("prediction_strength"),
            engine_confidence=domain_pred.get("confidence"),
            confluence_score=domain_pred.get("score"),
