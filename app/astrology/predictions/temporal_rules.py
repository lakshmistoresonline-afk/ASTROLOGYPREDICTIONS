TEMPORAL_RULE_REGISTRY_VERSION = "P0.3-R42"
...
TEMPORAL_EVENT_RULES = {
    "PROMOTION": {
        ...
        "rule_id": "R42-CAREER-PROMOTION-01"
    },
    "JOB_CHANGE": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-CAREER-JOBCHANGE-01"
    },
    "LEADERSHIP_APPOINTMENT": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-CAREER-LEADERSHIP-01"
    },
    "MARRIAGE": {
        "event_type": "MARRIAGE",
        "domain": "MARRIAGE",
    ...
    "SEPARATION_OR_DIVORCE": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-MARRIAGE-SEPARATION-01"
    },
    "INCOME_EXPANSION": {
    ...
    "FINANCIAL_PRESSURE": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-FINANCE-PRESSURE-01"
    },
    "PROPERTY_PURCHASE": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-PROPERTY-PURCHASE-01"
    },
    "PROPERTY_SALE": {
    ...
    "ACADEMIC_ENROLLMENT": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-EDUCATION-ENROLLMENT-01"
    },
    "CHILD_BIRTH": {
    ...
    "FOREIGN_SETTLEMENT": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-FOREIGN-SETTLEMENT-01"
    },
    "HEALTH_VITALITY": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-HEALTH-VITALITY-01"
    },
    "SPIRITUAL_INITIATION": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-SPIRITUAL_INITIATION-01"
    },
    "DEVELOPMENT": {
        ...
        "karakas": ["Jupiter", "Ketu"],
        "primary_houses": [9, 12, 5],
        "dasha_lords": ["Jupiter", "Ketu", "Saturn", "Venus"],
        "transit_planets": ["Jupiter", "Ketu", "Saturn", "Venus"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-SPIRITUAL-DEVELOPMENT-01"
    },
    "BUSINESS_LAUNCH": {
        ...
        "dasha_lords": ["Mercury", "Saturn", "Jupiter", "Venus"],
        "transit_planets": ["Mercury", "Saturn", "Jupiter", "Sun"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-BUSINESS-LAUNCH-01"
    },
    "FAMILY_EXPANSION": {
        "event_type": "FAMILY_EXPANSION",
        "domain": "FAMILY",
        "karakas": ["Jupiter", "Venus"],
        "primary_houses": [2, 4, 11],
        "dasha_lords": ["Jupiter", "Venus", "Moon"],
        "transit_planets": ["Jupiter", "Venus", "Moon"],
        "permitted_aspects": ["CONJUNCTION", "TRINE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-FAMILY-EXPANSION-01"
    },
    "LEGAL_VICTORY": {
        "event_type": "LEGAL_VICTORY",
        "domain": "LEGAL",
        "karakas": ["Mars", "Jupiter"],
        "primary_houses": [6, 11, 10],
        "dasha_lords": ["Mars", "Jupiter", "Saturn"],
        "transit_planets": ["Mars", "Jupiter", "Saturn"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-LEGAL-VICTORY-01"
    },
    "VEHICLE_PURCHASE": {
        ...
        "karakas": ["Venus", "Mars"],
        "primary_houses": [4, 11],
        "dasha_lords": ["Venus", "Mars", "Jupiter"],
        "transit_planets": ["Venus", "Mars", "Jupiter"],
        "permitted_aspects": ["CONJUNCTION", "TRINE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-VEHICLES-PURCHASE-01"
    },
    "INTERNATIONAL_JOURNEY": {
        "event_type": "INTERNATIONAL_JOURNEY",
        "domain": "TRAVEL",
        "karakas": ["Moon", "Rahu"],
        "primary_houses": [3, 7, 9, 12],
        "dasha_lords": ["Moon", "Rahu", "Jupiter", "Mercury"],
        "transit_planets": ["Moon", "Rahu", "Jupiter", "Mercury"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-TRAVEL-JOURNEY-01"
    },
    "PUBLIC_AWARD": {
        "event_type": "PUBLIC_AWARD",
        "domain": "FAME",
        "karakas": ["Sun", "Jupiter"],
        "primary_houses": [10, 11, 1],
        "dasha_lords": ["Sun", "Jupiter", "Saturn", "Venus"],
        "transit_planets": ["Sun", "Jupiter", "Saturn", "Mars"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-FAME-AWARD-01"
    },
    "IDENTITY_SHIFT": {
        "event_type": "IDENTITY_SHIFT",
        "domain": "PERSONALITY",
        "karakas": ["Sun", "Jupiter"],
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-PERSONALITY-SHIFT-01"
    },
    "CREATIVE_MANIFESTATION": {
        "event_type": "CREATIVE_MANIFESTATION",
        "domain": "CHILDREN",
        "karakas": ["Jupiter", "Mercury"],
        "primary_houses": [5, 9, 11],
        "dasha_lords": ["Jupiter", "Mercury", "Venus"],
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-CHILDREN-CREATIVE-01"
    },
    "RELATIONSHIP_BEGINNING": {
        "event_type": "RELATIONSHIP_BEGINNING",
        "domain": "MARRIAGE",
        "karakas": ["Venus", "Jupiter"],
        "primary_houses": [7, 2, 11],
        "dasha_lords": ["Venus", "Jupiter", "Moon", "Sun"],
        "transit_planets": ["Venus", "Jupiter", "Saturn", "Sun"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-MARRIAGE-BEGINNING-01"
    },
    "VISA_APPROVAL": {
        "event_type": "VISA_APPROVAL",
        "domain": "FOREIGN",
        "karakas": ["Rahu", "Moon", "Mars"],
        "primary_houses": [9, 12, 3, 4],
        "dasha_lords": ["Rahu", "Moon", "Saturn", "Venus"],
        "transit_planets": ["Rahu", "Moon", "Saturn", "Venus"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-FOREIGN-VISA-01"
    },
    "VITALITY_PEAK": {
        "event_type": "VITALITY_PEAK",
        "domain": "HEALTH",
        "karakas": ["Sun", "Mars"],
        "primary_houses": [1, 6],
        "dasha_lords": ["Sun", "Mars", "Jupiter", "Venus"],
        "transit_planets": ["Sun", "Mars", "Jupiter"],
        "permitted_aspects": ["CONJUNCTION", "TRINE", "SEXTILE"],
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R42-HEALTH-PEAK-01"
    }
}
