TEMPORAL_RULE_REGISTRY_VERSION = "P0.3-R41"
...
TEMPORAL_EVENT_RULES = {
    "PROMOTION": {
        ...
        "rule_id": "R41-CAREER-PROMOTION-01"
    },
    "JOB_CHANGE": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-CAREER-JOBCHANGE-01"
    },
    "LEADERSHIP_APPOINTMENT": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-CAREER-LEADERSHIP-01"
    },
    "MARRIAGE": {
        "event_type": "MARRIAGE",
        "domain": "MARRIAGE",
    ...
    "SEPARATION_OR_DIVORCE": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-MARRIAGE-SEPARATION-01"
    },
    "INCOME_EXPANSION": {
    ...
    "FINANCIAL_PRESSURE": {
        ...
        "max_orb": 5.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-FINANCE-PRESSURE-01"
    },
    "PROPERTY_PURCHASE": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-PROPERTY-PURCHASE-01"
    },
    "PROPERTY_SALE": {
    ...
    "ACADEMIC_ENROLLMENT": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-EDUCATION-ENROLLMENT-01"
    },
    "CHILD_BIRTH": {
    ...
    "FOREIGN_SETTLEMENT": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-FOREIGN-SETTLEMENT-01"
    },
    "HEALTH_VITALITY": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-HEALTH-VITALITY-01"
    },
    "SPIRITUAL_INITIATION": {
        ...
        "max_orb": 6.0,
        "required_confluence": "NATAL_AND_TEMPORAL_CONFLUENCE",
        "rule_id": "R41-SPIRITUAL_INITIATION-01"
    }
}
