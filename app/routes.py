...
def transit():
    ...
    session.get("birth_name", "Transit")
    session.get("birth_place", "")
...
def panchang():
    ...
    if dob and tob:
        try:
            ...
            from .astrology.predictions.data import NAK_SPAN
...
def _build_nak_house_map(transit_data: dict, natal_chart: dict | None) -> list:
    ...
    """
    from .astrology.core.planets import NAKSHATRA_NAMES, NAKSHATRA_LORDS
