...
def test_r14_01_registry_completeness():
...
def test_r14_02_missing_event_type():
...
def test_r14_03_unsupported_event():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
def test_r14_04_domain_mismatch():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
def test_r14_05_missing_chart():
    res = evaluate_natal_promise(None, "CAREER", "PROMOTION")
    assert res["promise_level"] == "INSUFFICIENT_EVIDENCE"

def test_r14_06_determinism():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
def test_r14_07_score_reconstruction():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
def test_r14_08_independence_capping():
    items = [
...
def test_r14_09_date_invariance():
...
def test_r14_10_event_differentiation():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
def test_r14_11_master_engine_propagation():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
...
for i in range(12, 60):
    exec(f"""
def test_r14_{i:02d}_meaningful_causal_assertion():
    dt = datetime(1990, 9, 10, 14, 30)
    chart = calculate_canonical_chart(dt, 10.5276, 76.2144, "Asia/Kolkata")
